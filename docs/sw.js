...
const SHELL = [
  ...
  './assets/src/utils.js?v=19',
  './assets/src/analytics.js?v=19',
  './assets/src/tmdb-client.js?v=19',
  './assets/src/ui.js?v=19',
  './assets/src/calendar.js?v=19',
  './assets/src/featured.js?v=19',
  './assets/src/notify.js?v=19',
  './assets/src/rating.js?v=19',
  './assets/src/calpicker.js?v=19',
  './assets/src/sections.js?v=19',
  './assets/src/app.js?v=19',
];
