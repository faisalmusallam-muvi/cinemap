...
const RAW_MOVIES = [
  ...
  { month: 2, ar: "Scream 7", en: "Scream 7", genre: "horror", date: "2026-03-19", pick: true,
  ...
  { month: 2, ar: "شباب البومب 3", en: "Shabab El Bomb 3", aliases: ["Shabab Al Bomb 3", "شباب البومب"], genre: "arabic", date: "2026-03-19", pick: true, language: 'ar', mood: 'fun',
  ...
  // APRIL
  { month: 3, ar: "Super Mario Galaxy", en: "The Super Mario Galaxy Movie", genre: "family", date: "2026-04-01", pick: true,
  ...
  { month: 7, ar: "The Dog Stars", en: "The Dog Stars", genre: "scifi", date: "2026-08-27", language: 'en', mood: 'deep',
    ...
    runtime: 120, rating: "PG-13" },
  { month: 7, ar: "Insidious 6", en: "Insidious: 6", genre: "horror", date: "2026-08-20",
  ...
  { month: 9, ar: "Whalefall", en: "Whalefall", genre: "thriller", date: "2026-10-15", language: 'en', mood: 'thrill',
    ...
    runtime: 112, rating: "PG-13" },
  { month: 9, ar: "Street Fighter", en: "Street Fighter", genre: "action", date: "2026-10-15", pick: true,
  ...
  { month: 11, ar: "Violent Night 2", en: "Violent Night 2", genre: "action", date: "2026-12-03",
    ...
    runtime: 105, rating: "R" },
  { month: 11, ar: "Dune 3", en: "Dune 3", genre: "scifi", date: "2026-12-17", pick: true,
  ...
  { month: 11, ar: "Jumanji: Open World", en: "Jumanji: Open World", genre: "comedy", date: "2026-12-24", pick: true, language: 'en', mood: 'fun',
  ...
  { month: 11, ar: "Ice Age 6", en: "Ice Age 6", genre: "family", date: "2026-12-17", language: 'en', mood: 'family',
    overview: "عودة أبطال Ice Age في مغامرة عائلية جديدة.",
    overviewEn: "The Ice Age crew returns for a new family adventure.",
    rating: "TBC" },
  { month: 11, ar: "The Angry Birds Movie 3", en: "The Angry Birds Movie 3", genre: "family", date: "2026-12-24", language: 'en', mood: 'family',
...
const KSA_BOX_OFFICE_PHASE1 = [
  ...
  { rank: 22, en: "Anaconda", admissions: 59782, grossSar: 3168616.21, weeks: 12 },
...
const KSA_BOX_OFFICE_IMPORTS = [
  ...
  { ar: "Anaconda", en: "Anaconda", genre: "comedy", date: "2026-02-12", language: "en", mood: "fun",
    overview: "عودة Anaconda بروح كوميدية ومغامرة للجمهور.",
    overviewEn: "Anaconda returns as a crowd-friendly comedy adventure." },
  ...
  { ar: "المجهولة", en: "Al Majhola", aliases: ["Al-Majhoola", "AL-MAJHOOLA", "Al Majhoola"], genre: "arabic", date: "2026-01-01", language: "ar", mood: "deep",
    overview: "دراما سعودية من عناوين 2026 المحلية.",
    overviewEn: "A Saudi drama from the 2026 local slate." },
  { ar: "ربشة", en: "Rabsha", aliases: ["RABSHA"], genre: "arabic", date: "2026-04-09", language: "ar", mood: "thrill",
    overview: "فيلم سعودي بتصنيف تشويق في بيانات شباك التذاكر.",
    overviewEn: "A Saudi suspense title in the box office data." },
  { ar: "هجير", en: "Hajeer", aliases: ["HAJEER"], genre: "arabic", date: "2026-04-02", language: "ar", mood: "deep",
    overview: "دراما سعودية وصلت لصالات 2026.",
    overviewEn: "A Saudi drama that reached 2026 cinema screens." },
  { ar: "أنا وسائقي", en: "My Driver & I", aliases: ["My Driver and I", "Ana Wa Saeqi", "Ana Wa Saiki"], genre: "arabic", date: "2026-01-22", language: "ar", mood: "deep",
