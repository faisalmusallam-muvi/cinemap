...
const RAW_MOVIES = [
  ...
  { month: 10, ar: "Ebenezer Scrooge", en: "Ebenezer Scrooge", genre: "drama", date: "2026-11-12", language: 'en', mood: 'deep',
    ...
    runtime: 120, rating: "PG-13" },
  { month: 10, ar: "Focker-In-Law", en: "Focker-In-Law", aliases: ["Focker In-Law", "Focker-in-Law", "Meet the Parents 4"], genre: "comedy", date: "2026-11-26",
  ...
  { month: 11, ar: "Violent Night 2", en: "Violent Night 2", genre: "action", date: "2026-12-03",
    ...
    runtime: 105, rating: "R" },
  { month: 11, ar: "Dune 3", en: "Dune 3", aliases: ["Dune: Part Three", "Dune Messiah"], genre: "scifi", date: "2026-12-17", pick: true,
